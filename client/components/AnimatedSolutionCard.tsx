        ...
        >
          ...
          <div className="absolute left-[21px] top-[192px] w-[223px]">
            ...
            <button
              ...
              className="flex items-center justify-between w-[99px] h-[27px] rounded-full bg-[#D6CECE] hover:bg-[#D6CECE]/80 transition-colors px-3 group absolute left-[124px] top-0"
            >
