  ...
  return (
    <div className="w-full h-80 bg-gradient-to-br from-gray-50 to-gray-100 border border-[#271D1D]/15 rounded-lg p-6 flex flex-col items-center justify-center">
      ...
      <div className="text-center mb-4">
        <h4 className="text-lg font-semibold text-[#271D1D] mb-2">AI Analysis Engine</h4>
        <div className="text-sm text-gray-600 mb-3">Processing contract with OpenAI GPT-4</div>
      ...
      <div className="bg-white rounded-lg p-3 w-full">
        <div className="text-center">
          <div className="text-sm font-medium text-[#271D1D] mb-2">AI Capabilities</div>
