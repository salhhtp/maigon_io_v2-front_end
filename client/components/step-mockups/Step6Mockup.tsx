    ...
    <div className="w-full h-full bg-gradient-to-br from-white to-[#F9F8F8] rounded-lg border border-[#271D1D]/15 overflow-hidden relative p-4">
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        ...
        <div className="bg-red-50 rounded-lg p-2 text-center">
          <div className="text-base font-bold text-red-600">1</div>
          <div className="text-xs text-red-700">High Risk</div>
        </div>
        <div className="bg-blue-50 rounded-lg p-2 text-center">
          <div className="text-base font-bold text-blue-600">47</div>
      ...
      <div className="flex gap-2 mt-auto">
        <button className="flex-1 bg-[#9A7C7C] text-white py-1.5 px-2 rounded-lg text-xs font-medium hover:bg-[#9A7C7C]/90 transition-colors">
          View Full Report
        </button>
        <button className="flex-1 bg-gray-100 text-gray-700 py-1.5 px-2 rounded-lg text-xs font-medium hover:bg-gray-200 transition-colors">
          Download PDF
        </button>
      </div>
