  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-white to-[#F9F8F8] rounded-lg border border-[#271D1D]/15 overflow-hidden relative p-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                ...
                privacy protections, and data subject obligations.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded">Privacy Rights</span>
                <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded">Data Protection</span>
                <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded">GDPR Compliance</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                ...
                compliance requirements, and organizational responsibilities.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded">Business Risk</span>
                <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded">Legal Compliance</span>
                <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded">Liability</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-blue-50 rounded-lg p-4 mb-4">
        <h4 className="font-medium text-[#271D1D] mb-2">Analysis will focus on:</h4>
