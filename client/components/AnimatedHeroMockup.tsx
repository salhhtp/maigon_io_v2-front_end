      ...
      <div className="relative h-full">
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            <div className="w-24 h-24 border-3 border-dashed border-[#9A7C7C] rounded-lg flex items-center justify-center mb-6">
              <Upload
                className={`w-12 h-12 text-[#9A7C7C] transition-transform duration-500 ${
                  currentStep === 0 ? "scale-100" : "scale-75"
                }`}
              />
            </div>
            <h3 className="text-2xl font-medium text-[#271D1D] mb-3">
              Upload Your Contract
            </h3>
            <p className="text-lg text-[#271D1D]/70 text-center">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <div className="relative mb-6">
              ...
              <div className="absolute -inset-3">
                <div
                  className={`w-30 h-30 border-3 border-[#9A7C7C] rounded-full animate-spin ${
            ...
            <p className="text-lg text-[#271D1D]/70 text-center mb-6">
            ...
            <div className="space-y-3 w-full max-w-md">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-[#271D1D]/60">
                  Checking GDPR compliance
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div
                  className="w-3 h-3 bg-[#9A7C7C] rounded-full animate-pulse"
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <h3 className="text-2xl font-medium text-[#271D1D] mb-6">
              Analysis Complete!
            </h3>
