      ...
      <section className="py-20 max-w-7xl mx-auto px-8 lg:px-16">
        <div className="flex items-center gap-1">
          ...
          <div className="flex flex-col items-start gap-7 w-full lg:w-[801px]">
            ...
            {/* Solutions Grid */}
            <div className="grid h-auto lg:h-[1368px] py-5 lg:py-[21px] gap-2 w-full grid-rows-3 grid-cols-1 lg:grid-cols-3 relative">
              {/* NDA Card */}
              ...
              {/* Privacy Policy Card */}
              <div className="flex w-[265px] pt-[15px] flex-col justify-end items-center row-start-1 row-span-1 col-start-3 col-span-1 bg-[#F3F3F3] relative">
                <div className="w-[265px] h-[424px] absolute left-0 top-[15px]">
                  <img
