...
const SolutionCard = ({ title, description, imageSrc }: { title: string; description: string; imageSrc: string }) => (
  <div className="bg-[#F3F3F3] rounded-lg overflow-hidden">
    <div className="p-4">
      <img src={imageSrc} alt={title} className="w-full h-57 object-cover rounded-lg mb-4" />
      <h3 className="text-xl font-medium text-[#271D1D] font-lora mb-2 leading-tight">{title}</h3>
...
const StepItem = ({ number, title, description, isActive = false }: { number: string; title: string; description: string; isActive?: boolean }) => (
  <div className="relative">
    ...
    <div className="pt-8 pb-6">
      <div className="flex justify-between items-start mb-4">
        ...
        <span className="text-2xl font-medium text-black font-lora">{number}</span>
      </div>
      <p className="text-sm text-black leading-relaxed max-w-md">{description}</p>
    </div>
  </div>
);
    ...
    <div className="min-h-screen bg-[#F9F8F8]">
      ...
      <section className="py-20 max-w-7xl mx-auto px-8 lg:px-16">
        <div className="flex items-center gap-1">
          ...
          <div className="flex flex-col items-start gap-7 w-full lg:w-[650px] lg:mr-5">
            ...
            <div className="grid h-auto lg:h-[1368px] py-5 lg:py-[21px] gap-0.5 w-full grid-rows-3 grid-cols-1 lg:grid-cols-3 relative">
              ...
              <div className="flex w-[200px] pt-[15px] flex-col justify-end items-center row-start-1 row-span-1 col-start-1 col-span-1 bg-[#F3F3F3] relative">
                <div className="w-[200px] h-[320px] absolute left-0 top-[15px]">
                  <img
              ...
              {/* DPA Card */}
              <div className="flex w-[200px] pt-[15px] flex-col justify-end items-center row-start-1 row-span-1 col-start-2 col-span-1 bg-[#F3F3F3] relative" style={{ marginLeft: "60px" }}>
              ...
              {/* EULA Card */}
              <div className="flex w-[200px] pt-[15px] flex-col justify-end items-center row-start-2 row-span-1 col-start-3 col-span-1 bg-[#F3F3F3] relative" style={{ marginLeft: "120px" }}>
              ...
              {/* PSA Card */}
              <div className="flex w-[200px] pt-[15px] flex-col justify-end items-center row-start-3 row-span-1 col-start-2 col-span-1 bg-[#F3F3F3] relative" style={{ marginLeft: "59px" }}>
                <div className="w-[265px] h-[424px] absolute left-0 top-[15px]">
                  <img
          ...
          <div className="hidden lg:flex flex-col items-center pb-[560px] relative">
            <div className="sticky top-[380px] flex h-[688px] p-2.5 justify-center items-end gap-2.5 w-[410px] ml-8">
      ...
      <section className="py-20 max-w-7xl mx-auto px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <FeatureCard
            icon={
              <svg width="98" height="96" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                <g clipPath="url(#clip0_629_5344)">
                  <path d="M91.4375 54H6.5625C3.22434 54 0.5 56.6963 0.5 60V84C0.5 87.3037 3.22434 90 6.5625 90H91.4375C94.7757 90 97.5 87.3037 97.5 84V60C97.5 56.7 94.7719 54 91.4375 54ZM67.1875 76.5C64.6772 76.5 62.6406 74.4844 62.6406 72C62.6406 69.5156 64.6772 67.5 67.1875 67.5C69.6978 67.5 71.7344 69.5156 71.7344 72C71.7344 74.4844 69.7072 76.5 67.1875 76.5ZM79.3125 76.5C76.8022 76.5 74.7656 74.4844 74.7656 72C74.7656 69.5156 76.8022 67.5 79.3125 67.5C81.8228 67.5 83.8594 69.5156 83.8594 72C83.8594 74.4844 81.8322 76.5 79.3125 76.5ZM79.3125 28.5C81.8228 28.5 83.8594 26.4844 83.8594 24C83.8594 21.5156 81.8322 19.5 79.3125 19.5C76.7928 19.5 74.7656 21.525 74.7656 24C74.7656 26.475 76.8117 28.5 79.3125 28.5Z" fill="#271D1D"/>
                  <path d="M91.4375 6H6.5625C3.22434 6 0.5 8.69625 0.5 12V36C0.5 39.3037 3.22434 42 6.5625 42H91.4375C94.7757 42 97.5 39.3037 97.5 36V12C97.5 8.69625 94.7719 6 91.4375 6ZM67.1875 28.5C64.6772 28.5 62.6406 26.4844 62.6406 24C62.6406 21.5156 64.6867 19.5 67.1875 19.5C69.6883 19.5 71.7344 21.525 71.7344 24C71.7344 26.475 69.7072 28.5 67.1875 28.5ZM79.3125 28.5C76.8022 28.5 74.7656 26.4844 74.7656 24C74.7656 21.5156 76.8117 19.5 79.3125 19.5C81.8133 19.5 83.8594 21.525 83.8594 24C83.8594 26.475 81.8322 28.5 79.3125 28.5ZM79.3125 67.5C76.8022 67.5 74.7656 69.5156 74.7656 72C74.7656 74.4844 76.8022 76.5 79.3125 76.5C81.8246 76.5 83.8594 74.4844 83.8594 72C83.8594 69.5156 81.8322 67.5 79.3125 67.5Z" fill="#B6A5A5"/>
                </g>
                <defs><clipPath id="clip0_629_5344"><rect width="97" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
          ...
          <FeatureCard
            icon={
              <svg width="97" height="96" viewBox="0 0 97 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                <path d="M87.6031 61.8375C82.109 78.6937 66.3844 90 48.3295 90C34.9731 90 22.7154 83.5312 15.1563 73.1062V87C15.1563 90.3169 12.4414 93 9.09375 93C5.74611 93 3.03125 90.3169 3.03125 87V60C3.03125 56.6831 5.74611 54 9.09375 54H33.3438C36.6914 54 39.4063 56.6831 39.4063 60C39.4063 63.3169 36.6914 66 33.3438 66H24.932C30.2557 73.4062 38.9326 78 48.5 78C61.1138 78 72.2006 70.0256 76.0654 58.1625C77.0927 55.0163 80.4949 53.2819 83.7004 54.3019C86.8832 55.1437 88.6451 58.6875 87.6031 61.8375Z" fill="#271D1D"/>
                <path d="M93.969 9V36C93.969 39.3169 91.2541 42 87.9065 42H63.6565C60.3088 42 57.594 39.3169 57.594 36C57.594 32.6831 60.3088 30 63.6565 30H72.0644C66.7445 22.5938 58.0676 18 48.5002 18C35.8826 18 24.7996 25.9688 20.9348 37.8375C19.9117 40.9875 16.4978 42.7312 13.2979 41.7C10.1132 40.6864 8.36267 37.2994 9.3933 34.1475C14.8893 17.3137 30.5969 6 48.5002 6C62.0196 6 74.2848 12.4725 81.844 22.8919V9C81.844 5.68313 84.5588 3 87.9065 3C91.2541 3 93.969 5.68313 93.969 9Z" fill="#B6A5A5"/>
              </svg>
            }
            ...
            icon={
              <svg width="86" height="96" viewBox="0 0 86 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-21 h-24">
                <g clipPath="url(#clip0_629_9)">
                  <path d="M85.5 15V24C85.5 32.2875 66.4699 39 43 39C19.5301 39 0.5 32.2875 0.5 24V15C0.5 6.71625 19.5301 0 43 0C66.4699 0 85.5 6.71625 85.5 15ZM75.1027 40.2562C78.8784 38.8687 82.673 37.0875 85.5 34.8938V54C85.5 62.2875 66.4699 69 43 69C19.5301 69 0.5 62.2875 0.5 54V34.8938C3.3327 37.0875 6.95469 38.8687 10.9068 40.2562C19.4087 43.2562 30.7623 45 43 45C55.2377 45 66.5837 43.2562 75.1027 40.2562ZM10.9068 70.2563C19.4087 73.2563 30.7623 75 43 75C55.2377 75 66.5837 73.2563 75.1027 70.2563C78.8784 68.8688 82.673 67.0875 85.5 64.8938V81C85.5 89.2875 66.4699 96 43 96C19.5301 96 0.5 89.2875 0.5 81V64.8938C3.3327 67.0875 6.95469 68.8688 10.9068 70.2563Z" fill="#271D1D"/>
                  <path d="M0.5 34.8938V24C0.5 32.2875 19.5301 39 43 39C66.4699 39 85.5 32.2875 85.5 24V34.8938C82.673 37.0875 78.8784 38.8687 75.1027 40.2562C66.5837 43.2562 55.2377 45 43 45C30.7623 45 19.4087 43.2562 10.9068 40.2562C6.95469 38.8687 3.3327 37.0875 0.5 34.8938ZM0.5 64.8938V54C0.5 62.2875 19.5301 69 43 69C66.4699 69 85.5 62.2875 85.5 54V64.8938C82.673 67.0875 78.8784 68.8688 75.1027 70.2563C66.5837 73.2563 55.2377 75 43 75C30.7623 75 19.4087 73.2563 10.9068 70.2563C6.95469 68.8688 3.3327 67.0875 0.5 64.8938Z" fill="#B6A5A5"/>
                </g>
                <defs><clipPath id="clip0_629_9"><rect width="85" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
            title="Our own data"
            ...
            icon={
              <svg width="98" height="96" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                <g clipPath="url(#clip0_629_6368)">
                  <path d="M49 0C75.7887 0 97.5 21.4875 97.5 48C97.5 74.5125 75.7887 96 49 96C22.2113 96 0.5 74.5125 0.5 48C0.5 21.4875 22.2113 0 49 0ZM42.9375 18C42.9375 21.3188 45.6467 24 49 24C52.3533 24 55.0625 21.3188 55.0625 18C55.0625 14.6869 52.3533 12 49 12C45.6467 12 42.9375 14.6869 42.9375 18ZM61.125 66C61.125 65.3063 61.0682 64.6313 60.9545 63.975L83.2152 50.325C85.3561 49.0125 86.0191 46.2375 84.693 44.1375C83.3668 42.0187 80.5629 41.3625 78.441 42.675L56.1613 56.325C54.1531 54.8625 51.6713 54 49 54C42.3123 54 36.875 59.3812 36.875 66C36.875 72.6188 42.3123 78 49 78C55.6877 78 61.125 72.6188 61.125 66ZM64.1562 27C64.1562 30.3188 66.8654 33 70.2188 33C73.5721 33 76.2812 30.3188 76.2812 27C76.2812 23.6812 73.5721 21 70.2188 21C66.8654 21 64.1562 23.6812 64.1562 27ZM24.75 48C24.75 44.6813 22.0408 42 18.6875 42C15.3399 42 12.625 44.6813 12.625 48C12.625 51.3187 15.3399 54 18.6875 54C22.0408 54 24.75 51.3187 24.75 48ZM21.7188 27C21.7188 30.3188 24.4279 33 27.7812 33C31.1346 33 33.8438 30.3188 33.8438 27C33.8438 23.6812 31.1346 21 27.7812 21C24.4279 21 21.7188 23.6812 21.7188 27Z" fill="#271D1D"/>
                  <path d="M78.441 42.6763C80.5629 41.3638 83.3668 42.0201 84.693 44.1388C86.0191 46.2388 85.3561 49.0138 83.2152 50.3263L60.9545 63.9763C61.0682 64.6326 61.125 65.3076 61.125 66.0013C61.125 72.6201 55.6877 78.0013 49 78.0013C42.3123 78.0013 36.875 72.6201 36.875 66.0013C36.875 59.3826 42.3123 54.0013 49 54.0013C51.6713 54.0013 54.1531 54.8638 56.1613 56.3263L78.441 42.6763Z" fill="#B6A5A5"/>
                </g>
                <defs><clipPath id="clip0_629_6368"><rect width="97" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
          ...
          <FeatureCard
            icon={
              <svg width="121" height="96" viewBox="0 0 121 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-30 h-24">
                <path d="M3.25847 23.5263L11.1424 7.89255C11.7152 6.7563 12.9498 6.10005 14.2222 6.25755L60.499 11.8263L44.7312 37.8888C43.3322 40.3826 40.5151 41.4701 37.8872 40.7388L7.00758 31.9826C3.36623 30.9513 1.56504 26.8825 3.25847 23.5263ZM113.985 31.9826L83.1109 40.7388C80.4829 41.4701 77.6659 40.3826 76.2668 37.8888L60.499 11.8263L106.782 6.25755C108.048 6.10005 109.277 6.7563 109.863 7.89255L117.747 23.5263C119.43 26.8825 117.634 30.9513 113.985 31.9826Z" fill="#271D1D"/>
                <path d="M76.2694 37.8938C77.6684 40.3875 80.4855 41.475 83.1134 40.7438L108.902 33.4313V70.9688C108.902 75.0938 106.066 78.6938 102.02 79.7063L63.432 89.2688C61.5036 89.7563 59.4995 89.7563 57.5711 89.2688L18.9834 79.7063C14.9356 78.6938 12.1016 75.0938 12.1016 70.9688V33.4313L37.8897 40.7438C40.5177 41.475 43.3347 40.3875 44.7338 37.8938L60.3314 12L76.2694 37.8938Z" fill="#B6A5A5" fillOpacity="0.611765"/>
              </svg>
            }
            title="Quick start"
