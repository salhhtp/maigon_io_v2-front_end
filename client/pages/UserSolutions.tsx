      ...
      <section className="py-20 max-w-7xl mx-auto px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard
            icon={
              <svg width="97" height="96" viewBox="0 0 97 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                <g clipPath="url(#clip0_629_13147)">
                ...
                <defs><clipPath id="clip0_629_13147"><rect width="97" height="96" fill="white"/></clipPath></defs>
              </svg>
            }
          ...
          <FeatureCard
            icon={
              <svg width="98" height="96" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                <g clipPath="url(#clip0_629_13255)">
                ...
                <defs><clipPath id="clip0_629_13255"><rect width="97" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
          ...
          <FeatureCard
            icon={
              <svg width="86" height="96" viewBox="0 0 86 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-21 h-24">
                <g clipPath="url(#clip0_629_20016)">
                ...
                <defs><clipPath id="clip0_629_20016"><rect width="85" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
          ...
          <FeatureCard
            icon={
              <svg width="86" height="96" viewBox="0 0 86 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-21 h-24">
                <g clipPath="url(#clip0_629_17098)">
                ...
                <defs><clipPath id="clip0_629_17098"><rect width="85" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
            title="Our own data"
          ...
          <FeatureCard
            icon={
              <svg width="98" height="96" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                ...
                <defs><clipPath id="clip0_629_95"><rect width="97" height="96" fill="white" transform="translate(0.5)"/></clipPath></defs>
              </svg>
            }
