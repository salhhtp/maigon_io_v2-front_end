...
import { ChevronDown, User, Bell, Shield, CreditCard, Globe, Palette, Download, Trash2, Eye, EyeOff } from "lucide-react";
...
const SettingsSection = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="bg-white rounded-lg p-6 border border-[#271D1D]/10">
    <h3 className="font-lora text-lg font-medium text-[#271D1D] mb-6">{title}</h3>
    {children}
  </div>
);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h1 className="text-3xl lg:text-4xl font-medium text-[#271D1D] font-lora">Settings</h1>
              <Link to="/profile">
          ...
          <div className="space-y-8">
            ...
            <SettingsSection title="Security">
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-[#271D1D] mb-2">Current Password</label>
                  <div className="relative">
                    <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#271D1D] mb-2">New Password</label>
                    <input
                      type="password"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#271D1D] mb-2">Confirm Password</label>
                    <input
                      type="password"
            ...
            <SettingsSection title="Data & Privacy">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-[#271D1D]">Export Your Data</p>
                    <p className="text-xs text-[#271D1D]/70">Download a copy of all your data</p>
                  </div>
                  <Button variant="outline" className="text-[#271D1D] border-[#271D1D]/20">
                    <Download className="w-4 h-4 mr-2" />
                    Export
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-[#271D1D]">Delete Account</p>
                    <p className="text-xs text-[#271D1D]/70">Permanently delete your account and all data</p>
                  </div>
            ...
            <SettingsSection title="API Access">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-[#271D1D]">API Keys</p>
                    <p className="text-xs text-[#271D1D]/70">Manage your API keys for integrations</p>
                  </div>
                  <Button variant="outline" className="text-[#271D1D] border-[#271D1D]/20">
                    Manage Keys
                  </Button>
                ...
                <div className="p-4 bg-[#F9F8F8] rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-[#271D1D]">Production Key</p>
                      <p className="text-xs text-[#271D1D]/70 font-mono">mk_live_••••••••••••••••••••••••••••</p>
                    </div>
