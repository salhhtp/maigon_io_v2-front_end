            ...
            <div className="space-y-8">
              {isAdmin ? (
                <>
                  ...
                  {/* Admin Quick Upload Access */}
                  <div className="bg-white rounded-lg p-6 border border-[#271D1D]/10">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="font-lora text-lg font-medium text-[#271D1D]">
                        Quick Upload
                      </h3>
                      <div className="px-2 py-1 bg-[#9A7C7C]/10 text-[#9A7C7C] rounded text-xs font-medium">
                        Admin Fast Track
                      </div>
                    </div>
                    <p className="text-sm text-[#271D1D]/70 mb-4">
                      Skip the selection process and test solutions with direct upload access.
                    </p>
                    <div className="space-y-2">
                      ...
                      >
                        <Button
                          variant="outline"
                          size="sm"
                          className="w-full justify-start text-[#271D1D] border-[#271D1D]/20 hover:bg-[#9A7C7C]/5"
                        >
                          <Plus className="w-4 h-4 mr-2" />
                          Test DPA Solution
                        </Button>
                      ...
                      <Collapsible>
                        <CollapsibleTrigger asChild>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="w-full justify-center text-[#9A7C7C] hover:bg-[#9A7C7C]/5 mt-2"
                          >
                ...
                <>
                  ...
                  <div className="bg-white rounded-lg p-6 border border-[#271D1D]/10">
                    ...
                    <p className="text-sm text-[#271D1D]/70 mb-4">
                      Skip the selection process and upload directly to your most-used solutions.
                    </p>
                    <div className="space-y-2">
                      <Link
                        to="/perspective-selection"
