...
export default function ContractReview() {
  ...
  const { contract, review, selectedFile, perspective, solutionTitle } =
    location.state || {};
      ...
      setAgentMessages([
        {
          ...
          role: "agent",
          content:
            "Hi there! I'm Maigon's contract co-pilot. I can help transform these insights into updated clauses, negotiation-ready language, or summaries for stakeholders.",
        ...
        },
        {
          ...
          role: "agent",
          content:
            "Try asking me to draft a revised indemnification clause or prepare a bullet summary for your legal team.",
          timestamp: new Date().toISOString(),
        },
      ]);
    }
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
                  ...
                  {agentIsThinking && (
                    <div className="flex items-center gap-2 text-xs text-[#725A5A]">
                      <Bot className="w-3 h-3 animate-pulse" /> Agent is
