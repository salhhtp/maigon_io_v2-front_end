...
/**
 * New section schemas introduced in v3
 */
export const playbookInsightSchema = z.object({
  id: z.string(),
  title: z.string(),
  summary: z.string(),
...
export const deviationInsightSchema = z.object({
  id: z.string(),
  title: z.string(),
...
/**
 * Report schemas & compatibility helpers
 */
...
export type PlaybookInsight = z.infer<typeof playbookInsightSchema>;
...
export type DeviationInsight = z.infer<typeof deviationInsightSchema>;
...
export function convertV2ReportToV3(report: AnalysisReportV2): AnalysisReport {
  return {
    ...report,
    version: "v3",
    playbookInsights: [],
